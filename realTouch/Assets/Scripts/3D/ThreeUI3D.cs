...
public class ThreeUI3D : BaseThreeD
{
    protected CameraControl cc
    {
     ...
     public ThreeUI3D(int xPosition, BaseUI baseUI)
        : base(xPosition, baseUI)
    {
       

            ResManager.Instance.LoadCoroutineInstance(UIPathDefines.THREE_DIMENSIONAL + "Three_", (Object) =>
            {
    ...
    {
        Message message = new Message(MessageType.Net_ThreeUI3d_ThreeUI, this);
